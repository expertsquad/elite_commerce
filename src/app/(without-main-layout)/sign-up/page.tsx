...
const Page = () => {
  ...
  return (
    // <div
    //   className={`flex items-center justify-center h-full w-full relative login-signup-container-background`}
    // >
    ...
    <div className="flex items-center justify-center h-screen w-7xl relative login-signup-container-background ">
      <div className="absolute top-0 max-w-7xl w-full h-full ">
        <Image
