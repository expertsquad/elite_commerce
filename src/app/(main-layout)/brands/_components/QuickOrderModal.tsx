...
export const OrderSummery = () => {
  return (
    <div className="md:border border-black-10 rounded-[10px] px-5 py-3.5  space-y-2.5">
...
const QuickOrderModal = ({
  ...
  return (
    <Modal
      ...
      setShow={setShow}
      alignment="center"
      className="md:w-2/4 w-full h-[800px] overflow-y-auto"
    >
      <div className="flex justify-between gap-5 md:flex-row flex-col-reverse md:p-0 p-3.5 relative">
        ...
        <div className="flex-1">
          ...
          <Link
            href={"/"}
            className="uppercase text-black-80 flex items-center justify-center mt-5 gap-2"
          >
            <IconArrowLeft />
