  ...
  return (
    <div className="relative w-full h-6">
      <div className="relative w-full bg-black-10 rounded-full h-1.5">
        <div
          className="absolute top-0 left-0 bg-gradient-primary rounded-full h-1.5"
          style={{ width: `${progress}%` }}
        />
      </div>
      <div
        className="absolute -top-[9px] w-[26px] h-[26px]  bg-white rounded-full text-black-80 flex items-center justify-center text-[10px] select-none"
        style={{
